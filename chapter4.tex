...
The observation that the umbra exhibits different behavior compared to other regions of the FoV in both previous analyses suggests that the amplitude and behavior of these effects are sensitive to the shape of the spectral profile and the FPI's transmission profile. Therefore etalons with different properties may offer different performances. 
