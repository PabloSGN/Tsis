...
\begin{figure}
  ...
  \begin{minipage}[c]{0.27\textwidth}
    \caption{
      The top row shows the flat-fields observed at the core of the line for both the simulations without (left) and with (right) cavity. The bottom row shows the spectral profile of the pixels marked with an "X" of the corresponding color, for both scenarios, and before and after the normalization.      
