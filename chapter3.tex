...
\begin{figure}[t]
  ...
  \caption[Micropolarizer observations.]{
   Micropolarizer observation with the boundaries of the array of linear polarizers overplotted. The right panel in the top row shows the orientation of the linear polarizer that compose each array.}
