...
Fabry-Pérot Interferometers (FPIs), also known as etalons (used interchangeably), represent one of the most prevalent forms of narrow-band tunable spectrographs. Composed by a resonant optical cavity formed by two distinct optical media, these devices permit only the passage of light with wavelengths corresponding to constructive interference within the cavity. By changing the distance between the two reflecting surfaces, or mirrors, or by modifying the refractive index of the material within te cavity, it is posible to select the wavelengths allowed through the cavity.
