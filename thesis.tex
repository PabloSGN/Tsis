...
\begin{figure*}
    \centering
    {\includegraphics[width=16cm]{Figures/PersistentHomology/QuietSun.pdf}}
...
\begin{figure}
    \centering
    {\includegraphics[width=16cm]{Figures/PersistentHomology/AR_analysis_v2.pdf}}
...
\begin{figure}
    \centering
     \includegraphics[width=12cm]{Figures/PersistentHomology/AR_classification.pdf}
